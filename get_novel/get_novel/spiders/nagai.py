...
class NagaiSpider(scrapy.Spider):
    name = 'nagai'
    allowed_domains = ['www.aozora.gr.jp']
    start_urls = ['https://www.aozora.gr.jp/index_pages/person1341.html']
    ...
    def parse_item(self, response):
        ...
        fname = "/home/yoshi/work_dir/cmp_d2c_topic/comp_d2v_tpmodel/get_novel/novels/nagai/" + title + ".zip"
